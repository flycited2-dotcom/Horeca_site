...
return [
    ...
    'errors' => [
        ...
        'photos_failed' => 'Не удалось получить фото поставщика: :reason',
    ...
    'photos' => [
        'queued' => 'Загрузка фото поставлена в очередь imports со страницы :page. Ход — в журнале storage/logs.',
        'page_done' => 'Фото поставщика: страница :page из :last готова.',
